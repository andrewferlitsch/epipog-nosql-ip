...
java query -i tests\4.txt -Smoney:integer,temp:float,date:date,time:time -d binary -F psv
IF %ERRORLEVEL% NEQ 0 (  echo FAILED rc ) else ( echo PASSED )
java query -s money,time,date,temp >stdout
...
del \tmp\tmp.*
java query -i tests\4.txt -Smoney:integer,temp:float,date:date,time:time -d csv -F psv
IF %ERRORLEVEL% NEQ 0 (  echo FAILED rc ) else ( echo PASSED )
java query -s money,time,date,temp -d csv >stdout
find "20,12:03,2016-10-02,6.2" stdout >tmp
if %ERRORLEVEL% NEQ 0 ( echo FAILED stdout ) else ( echo PASSED )

echo "Test: psv store, integer,float,date,time"
del \tmp\tmp.*
java query -i tests\4.txt -Smoney:integer,temp:float,date:date,time:time -d psv -F psv
IF %ERRORLEVEL% NEQ 0 (  echo FAILED rc ) else ( echo PASSED )
java query -s money,time,date,temp -d psv >stdout
find "20,12:03,2016-10-02,6.2" stdout >tmp
if %ERRORLEVEL% NEQ 0 ( echo FAILED stdout ) else ( echo PASSED )

echo "Test: json store, integer,float,date,time"
del \tmp\tmp.*
java query -i tests\4.txt -Smoney:integer,temp:float,date:date,time:time -d json -F psv
IF %ERRORLEVEL% NEQ 0 (  echo FAILED rc ) else ( echo PASSED )
java query -s money,time,date,temp -d json >stdout
find "20,12:03,2016-10-02,6.2" stdout >tmp
if %ERRORLEVEL% NEQ 0 ( echo FAILED stdout ) else ( echo PASSED )

echo "Test: binary store, hex numbers and leading zeros"
del \tmp\tmp.*
java query -i tests\4a.txt -Smoney:integer,temp:float,date:date,time:time -d binary -F psv
IF %ERRORLEVEL% NEQ 0 (  echo FAILED rc ) else ( echo PASSED )
java query -s money,time,date,temp -d binary >stdout
find "66,11:00,2016-10-01,7.6" stdout >tmp
if %ERRORLEVEL% NEQ 0 ( echo FAILED stdout ) else ( echo PASSED )

echo "Test: csv store, hex numbers and leading zeros"
del \tmp\tmp.*
java query -i tests\4a.txt -Smoney:integer,temp:float,date:date,time:time -d csv -F psv
IF %ERRORLEVEL% NEQ 0 (  echo FAILED rc ) else ( echo PASSED )
java query -s money,time,date,temp -d csv >stdout
find "66,11:00,2016-10-01,7.6" stdout >tmp
if %ERRORLEVEL% NEQ 0 ( echo FAILED stdout ) else ( echo PASSED )
...
del \tmp\tmp.*
java query -i tests\4a.txt -Smoney:integer,temp:float,date:date,time:time -d psv -F psv
IF %ERRORLEVEL% NEQ 0 (  echo FAILED rc ) else ( echo PASSED )
java query -s money,time,date,temp -d psv >stdout
find "66,11:00,2016-10-01,7.6" stdout >tmp
if %ERRORLEVEL% NEQ 0 ( echo FAILED stdout ) else ( echo PASSED )
...
del \tmp\tmp.*
java query -i tests\4a.txt -Smoney:integer,temp:float,date:date,time:time -d json -F psv
IF %ERRORLEVEL% NEQ 0 (  echo FAILED rc ) else ( echo PASSED )
java query -s money,time,date,temp -d json >stdout
find "66,11:00,2016-10-01,7.6" stdout >tmp
if %ERRORLEVEL% NEQ 0 ( echo FAILED stdout ) else ( echo PASSED )
...
del \tmp\tmp.*
java query -i tests\4b.txt -Smoney:integer,temp:float,date:date,time:time -d binary -F psv
IF %ERRORLEVEL% NEQ 0 (  echo FAILED rc ) else ( echo PASSED )
java query -s money,time,date,temp -d binary >stdout
find "66,11:00,2016-10-01,7.6" stdout >tmp
if %ERRORLEVEL% NEQ 0 ( echo FAILED stdout ) else ( echo PASSED )
...
del \tmp\tmp.*
java query -i tests\4b.txt -Smoney:integer,temp:float,date:date,time:time -d csv -F psv
IF %ERRORLEVEL% NEQ 0 (  echo FAILED rc ) else ( echo PASSED )
java query -s money,time,date,temp -d csv >stdout
find "66,11:00,2016-10-01,7.6" stdout >tmp
if %ERRORLEVEL% NEQ 0 ( echo FAILED stdout ) else ( echo PASSED )
...
del \tmp\tmp.*
java query -i tests\4b.txt -Smoney:integer,temp:float,date:date,time:time -d psv -F psv
IF %ERRORLEVEL% NEQ 0 (  echo FAILED rc ) else ( echo PASSED )
java query -s money,time,date,temp -d psv >stdout
find "66,11:00,2016-10-01,7.6" stdout >tmp
if %ERRORLEVEL% NEQ 0 ( echo FAILED stdout ) else ( echo PASSED )
...
del \tmp\tmp.*
java query -i tests\4b.txt -Smoney:integer,temp:float,date:date,time:time -d json -F psv
IF %ERRORLEVEL% NEQ 0 (  echo FAILED rc ) else ( echo PASSED )
java query -s money,time,date,temp -d json >stdout
find "66,11:00,2016-10-01,7.6" stdout >tmp
if %ERRORLEVEL% NEQ 0 ( echo FAILED stdout ) else ( echo PASSED )
...
del \tmp\tmp.*
java query -i tests\4c.txt -Smoney:integer,temp:float,date:date,time:time -d binary -F psv 2>stderr
...
del \tmp\tmp.*
java query -i tests\4c.txt -Smoney:short,temp:float,date:date,time:time -d binary -F psv 2>stderr
IF %ERRORLEVEL% NEQ 1 (  echo FAILED rc ) else ( echo PASSED )
find "Incorrect value for data type: ab" stderr >stdout
if %ERRORLEVEL% NEQ 0 ( echo FAILED stderr ) else ( echo PASSED )
...
del \tmp\tmp.*
java query -i tests\4c.txt -Smoney:long,temp:float,date:date,time:time -d binary -F psv 2>stderr
IF %ERRORLEVEL% NEQ 1 (  echo FAILED rc ) else ( echo PASSED )
find "Incorrect value for data type: ab" stderr >stdout
if %ERRORLEVEL% NEQ 0 ( echo FAILED stderr ) else ( echo PASSED )
...
del \tmp\tmp.*
java query -i tests\4d.txt -Smoney:long,temp:float,date:date,time:time -d binary -F psv 2>stderr
IF %ERRORLEVEL% NEQ 1 (  echo FAILED rc ) else ( echo PASSED )
...
del \tmp\tmp.*
java query -i tests\4d.txt -Smoney:long,temp:double,date:date,time:time -d binary -F psv 2>stderr
IF %ERRORLEVEL% NEQ 1 (  echo FAILED rc ) else ( echo PASSED )
find "Incorrect value for data type: 6.x" stderr >stdout
if %ERRORLEVEL% NEQ 0 ( echo FAILED stderr ) else ( echo PASSED )
...
del \tmp\tmp.*
java query -i tests\4e.txt -Smoney:long,temp:double,date:date,time:time -d binary -F psv 2>stderr
IF %ERRORLEVEL% NEQ 1 (  echo FAILED rc ) else ( echo PASSED )
...
del \tmp\tmp.*
java query -i tests\4f.txt -Smoney:long,temp:double,date:date,time:time -d binary -F psv 2>stderr
IF %ERRORLEVEL% NEQ 1 (  echo FAILED rc ) else ( echo PASSED )
...
del \tmp\tmp.*
java query -i tests\4g.txt -Scountry:string16,state:string16 -F csv 2>stderr
IF %ERRORLEVEL% NEQ 1 (  echo FAILED rc ) else ( echo PASSED )
...
del \tmp\tmp.*
java query -i tests\4g.txt -Scountry:string32,state:string16 -F csv 2>stderr
IF %ERRORLEVEL% NEQ 1 (  echo FAILED rc ) else ( echo PASSED )
